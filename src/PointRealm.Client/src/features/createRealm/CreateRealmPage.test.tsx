...
describe('CreateRealmPage', () => {
    ...
    it('validates custom deck parsing (< 3 values)', async () => {
        ...
        const input = screen.getByPlaceholderText('0, 1, 2, 3, 5, 8, 13, ?, ☕');
    ...
    it('validates custom deck parsing (valid)', async () => {
        ...
        // Fill Display Name
        fireEvent.change(screen.getByPlaceholderText('e.g. Gandalf'), { target: { value: 'Merlin' } });
    ...
    it('disables submit button while loading', async () => {
        ...
        // Fill required
        fireEvent.change(screen.getByPlaceholderText('e.g. Gandalf'), { target: { value: 'TestUser' } });
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('Casting Spell...')).toBeInTheDocument();
        });
